...
export function MeetingsFamilia() {
  const handleLeadClick = (meetingType: string) => {
    const eventId = `lead-${Date.now()}`;
    
    // Pixel Event
    trackMetaEvent('Lead', {
      content_name: `Agendamento ${meetingType} - Família`,
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        >
          <div className="content relative z-[2] p-6 sm:p-8 md:p-12 w-full md:w-3/4 flex flex-col justify-center">
            ...
            <a 
              href="https://api.whatsapp.com/send/?phone=5561991591105&text=Ol%C3%A1%21+Gostaria+de+agendar+uma+reuni%C3%A3o+presencial+sobre+um+caso+de+fam%C3%ADlia.&type=phone_number&app_absent=0"
              target="_blank"
        ...
        >
          <div className="content relative z-[2] p-6 sm:p-8 md:p-12 w-full md:w-3/4 flex flex-col justify-center">
            ...
            <a 
              href="https://api.whatsapp.com/send/?phone=5561991591105&text=Ol%C3%A1%21+Gostaria+de+marcar+uma+reuni%C3%A3o+online+sobre+um+caso+de+fam%C3%ADlia.&type=phone_number&app_absent=0"
              target="_blank"
              rel="noopener noreferrer"
